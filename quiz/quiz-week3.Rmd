...
Answer
1. Dependent variable, response variable, target variable 
2. Predictors, independent variable, features 
...
1. Relationship between changes in x variables and changes in y variable
2. How good a predictor of y x may be 
...
1. The Y: is a function of the x's, their coefficents, and the intercept
2. The X's: Sepal.Width, Petal.Length, Petal.Width
3. The full (model) formula for the model: call:(lm. . .) 
...
1. A restrictive class of functions
2. A search routine to search that class for the best function
3. A function for measuring error
